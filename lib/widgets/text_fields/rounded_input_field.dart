...
import 'package:donotnote/widgets/text_fields/text_field_container.dart';
      ...
      child: TextFieldContainer(
        child: TextFormField(
          ...
          validator: (value) {
            ...
            if (type == 'Title') {
              if (value == null) {
                return Strings.titleMustNotBeEmpty;
              }
              if (value.length > 40) {
                return Strings.titleMustBe40;
              }
            ...
            if (widget.limit != null) {
              if (value == null) {
                return Strings.commentMustNotBeEmpyt;
              }
              if (widget.limit! < value.length) {
                return Strings.commentMustBeUnder50;
              }
              if (validCharacters.hasMatch(value)) {
                return Strings.usernameMustBeCorrect;
              }
          ...
          decoration: InputDecoration(
            ...
            errorStyle: const TextStyle(color: KColors.kTextColor),
