import 'package:donotnote/widgets/morpheus/morpheus_route_arguments.dart';
import 'package:flutter/material.dart';
import 'tweens/page_transition_child_tween.dart';
import 'tweens/page_transition_opacity_tween.dart';

/// Builds a parent-child material design navigation transition.
class MorpheusPageTransition extends StatelessWidget {
  const MorpheusPageTransition({
    super.key,
    this.renderBox,
    this.renderBoxSize,
  ...
  BorderRadiusTween get borderRadius => BorderRadiusTween(
        begin: settings.borderRadius as BorderRadius? ??
  ...
  Widget build(BuildContext context) {
    ...
    final Animation<Color?> scrimAnimation = ColorTween(
      begin: settings.scrimColor.withOpacity(0.5),
